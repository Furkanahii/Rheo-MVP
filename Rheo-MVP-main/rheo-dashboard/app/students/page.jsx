  ...
  return (
    <div className="page-stack">
      ...
      <section className="stats-grid">
        <InfoPanel
          title="Takipte"
          value={formatInteger(overview.allStudents.filter((student) => student.status === "on_track").length)}
          caption="Öğrenci"
        />
        <InfoPanel
          title="Uyarı"
          value={formatInteger(overview.allStudents.filter((student) => student.status === "warning").length)}
          caption="Öğrenci"
        />
        <InfoPanel
          title="Riskli"
          value={formatInteger(overview.allStudents.filter((student) => student.status === "at_risk").length)}
          caption="Öğrenci"
        />
        <InfoPanel
          title="Sync bekleyen"
          value={formatInteger(overview.allStudents.filter((student) => student.status === "pending").length)}
          caption="Öğrenci"
        />
      </section>
