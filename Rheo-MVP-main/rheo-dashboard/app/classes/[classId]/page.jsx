...
export default function ClassDetailPage({ params, searchParams }) {
  ...
  return (
    <div className="page-stack">
      ...
      <StudentsTable students={detail.students.filter((student) => student.hasProgress)} showClass={false} />
      <AssignmentBoard
        buckets={{
          upcoming: detail.assignments.filter((assignment) => assignment.bucket === "upcoming"),
          today: detail.assignments.filter((assignment) => assignment.bucket === "today"),
