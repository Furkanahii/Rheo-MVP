      ...
      builder: (ctx) => AlertDialog(
        ...
        content: TextField(
          ...
          decoration: InputDecoration(
            hintText: 'ÔÇóÔÇóÔÇóÔÇóÔÇóÔÇóÔÇóÔÇó',
          ...
          onSubmitted: (value) {
            ...
            if (value == _adminPin) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text(S.tr('Yanl─▒┼ş PIN', 'Wrong PIN')), backgroundColor: RheoColors.error),
              );
            }
          },
        ),
        actions: [
          TextButton(
            ...
            child: Text(S.tr('─░ptal', 'Cancel'), style: TextStyle(color: RheoTheme.textMuted)),
          ),
          ElevatedButton(
            onPressed: () {
              Navigator.pop(ctx);
            ...
            child: Text(S.tr('Giri┼ş', 'Enter'), style: const TextStyle(color: Colors.white)),
          ),
        ],
      ),
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(S.tr('Hakk─▒m─▒zda', 'About Us'), style: TextStyle(color: RheoTheme.textColor)),
        actions: [
          // Hidden admin button ÔÇö very small, blends with background
          IconButton(
            ...
            children: [
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        S.tr('Kodla ├û─şren, Oynayarak Geli┼ş', 'Learn to Code, Level Up Playing'),
                        style: TextStyle(
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text(
                            S.tr('Uygulama Hakk─▒nda', 'About the App'),
                      ...
                      Text(
                        S.tr(
                          'Rheo, kod okuma ve anlama becerilerini geli┼ştirmek i├ğin tasarlanm─▒┼ş e─şlenceli ve ba─ş─▒ml─▒l─▒k yapan bir oyun. '
                          'Python, Java ve JavaScript dillerinde ├ğe┼şitli kod par├ğac─▒klar─▒n─▒ analiz ederek ├ğ─▒kt─▒lar─▒n─▒ tahmin et, '
                          'Bug Hunter modunda hatal─▒ sat─▒rlar─▒ bul ve ELO sisteminde y├╝ksel!',
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildFeatureRow(Icons.translate, S.tr('T├╝rk├ğe & ─░ngilizce', 'Turkish & English'), RheoColors.warning),
                      _buildFeatureRow(Icons.smart_toy, S.tr('AI destekli soru ├╝retimi', 'AI-powered question generation'), RheoColors.error),
                    ],
                  ),
                ),
              ),
              ...
              StaggeredFadeIn(
                ...
                child: Row(
                  children: [
                    Text(
                      S.tr('GEL─░┼ŞT─░R─░C─░ EK─░P', 'DEVELOPMENT TEAM'),
                      style: TextStyle(
                        color: RheoTheme.textMuted,
                        fontSize: 12,
                        letterSpacing: 2,
              ...
              StaggeredFadeIn(
                ...
                child: _buildTeamMember(
                  name: 'Furkan Ahi',
                  role: S.tr('Bo─şazi├ği ├£niversitesi ÔÇó Kurucu', 'Bo─şazi├ği University ÔÇó Founder'),
              ...
              StaggeredFadeIn(
                index: 6,
                child: _buildTeamMember(
                  name: 'Bahad─▒r Erdo─şan',
                  role: S.tr('Y─▒ld─▒z Teknik ├£niversitesi ÔÇó Kurucu', 'Y─▒ld─▒z Technical University ÔÇó Founder'),
                  icon: Icons.person_rounded,
              ...
              StaggeredFadeIn(
                ...
                child: Container(
                  ...
                  child: ListTile(
                    ...
                    title: Text(S.tr('Gizlilik Politikas─▒', 'Privacy Policy'), 
